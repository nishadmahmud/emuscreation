    ...
    <nav className="h-16 flex items-center bg-[var(--bg-elevated)]">
      <div className="relative flex w-full items-center">
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className={`${playfair.className} text-2xl leading-none text-[var(--text-primary)]`}
          >
            Emu&apos;s Creation
          </Link>
        </div>
          ...
          >
            ...
            {isActive("/services") ? (
              <motion.div
                ...
                className="absolute left-0 right-0 -bottom-0.5 h-0.5 bg-[#D4A514] rounded-full"
        ...
        <div className="ml-auto hidden md:flex items-center gap-3">
          ...
          <a
            ...
            className="rounded bg-[#D4A514] text-black px-3 py-1.5 font-medium"
          >
            Get a Quote
          </a>
        </div>
        ...
        >
          <div className="px-4 py-4 flex flex-col gap-3 text-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded bg-[#D4A514] text-black px-3 py-2 font-medium"
              onClick={() => setOpen(false)}
            >
              Get a Quote
            </a>
