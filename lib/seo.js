...
export const generateMetadata = ({
  ...
  path = '',
  image = null, // null for now, add '/og-default.jpg' when image is ready
  type = 'website',
  keywords = [],
  noIndex = false,
}) => {
  ...
  // Use default placeholder or provided image
  const defaultImage = image || `${BASE_URL}/placeholder-og.jpg`;
