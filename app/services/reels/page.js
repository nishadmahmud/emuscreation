        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              onClick={() => window.open('/car.mp4', '_blank')}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-3 mb-8 flex-grow">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-[var(--text-primary)]">3-day delivery</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">1 Commercially licensed video clip</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">1 Commercially licensed image</span>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-3 mb-8 flex-grow">
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">5-day delivery</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">2 Commercially licensed music tracks</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-[var(--text-secondary)]">
                  5 reels or TikToks with viral edits
                </p>
              </div>
              ...
              <div className="space-y-3 mb-8 flex-grow">
                ...
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">5 Revisions</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <FaCheck className="text-green-400 flex-shrink-0" />
                  <span className="text-[var(--text-primary)]">Up to 1 minute running time</span>
