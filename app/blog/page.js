...
const categories = ["All", "Wedding", "Social Media", "YouTube", "Tutorial", "Corporate", "Travel"];
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-12">
      ...
      <header className="text-center mb-16">
        ...
        >
          Stay updated with the latest trends, tips, and techniques in video editing and content creation.
        </motion.p>
      </header>
      ...
      >
        ...
        <p className="text-[var(--text-secondary)] mb-8 max-w-2xl mx-auto">
          Put these tips into practice with our professional video editing services. From wedding highlights to corporate content, we bring your vision to life.
        </p>
